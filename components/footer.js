  ...
  return (
    <footer className="bg-accent-1 border-t border-accent-2">
      <Container>
        <div className="py-28 flex flex-col lg:flex-row items-center">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center lg:pl-4 lg:w-1/2">
            ...
            >
              <svg className="h-6 w-6 link_blog" fill="none" viewBox="0 0 20 20" stroke="currentColor">
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
            >
              <svg className="h-6 w-6 link_blog"  fill="none" >
      ...
      <div className="py-2 text-center text-sm">
            Website made with {' '}
            <a href="https://reactjs.org" className="topLabel underline" target="_blank" rel="noopener noreferrer">React</a>,  {' '}
            <a href="https://nextjs.org" className="topLabel underline" target="_blank" rel="noopener noreferrer">NextJs</a>,  {' '}
            <a href="https://datocms.com" className="topLabel underline" target="_blank" rel="noopener noreferrer">DatoCms</a>.  {' '}
            Hosted on {' '} 
            <a href="https://vercel.com" className="topLabel underline" target="_blank" rel="noopener noreferrer">Vercel</a>. {' '} Thanks  {' '}
            <a href="https://www.softwaremonkey.com.ec" className="topLabel underline" target="_blank" rel="noopener noreferrer">Software Monkey Ecuador</a>
      </div>
    </footer>
  )
}
